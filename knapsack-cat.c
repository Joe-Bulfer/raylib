/*
gcc scratch-knapsack.c -o scratch-knapsack -I ../raylib-quickstart/build/external/raylib-master/src/ -L ../raylib-quickstart/bin/Debug/ -lraylib -lm -lpthread -ldl -lX11 && ./scratch-knapsack
*/
